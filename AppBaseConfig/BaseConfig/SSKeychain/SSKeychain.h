...
/**
 ...
 @param account The account for which to return the corresponding password.
  ...
  error  If accessing the password fails, upon return contains an error that describes the problem.
...
/**
 ...
 @param account The account for which to set the corresponding password.
  ...
  error If setting the password fails, upon return contains an error that describes the problem.
